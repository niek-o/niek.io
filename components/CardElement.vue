...
import { pageOptions, platform } from "~/utils/typings";
...
<template>
  <div v-if="type === 'youtube'">
    ...
    <div class="card flex flex-row justify-items-stretch items-center w-full h-22">
      ...
      <div class="justify-self-end">
        <svg class="icon flex-1 mx-10 m-2 h-14 w-auto" xmlns="http://www.w3.org/2000/svg" viewBox="-2 -5 24 24" width="24">
  ...
  <div v-if="type === 'spotify'">
    ...
    <div class="card flex flex-row justify-items-stretch items-center w-full h-22">
      ...
      <div class="justify-self-end">
        <svg class="icon flex-1 mx-10 m-2 h-14 w-auto" xmlns="http://www.w3.org/2000/svg" viewBox="-2 -2 24 24" width="24">
  ...
  <div v-if="type === 'soundcloud'">
    ...
    <div class="card flex flex-row justify-items-stretch items-center w-full h-22">
      ...
      <div class="justify-self-end">
        <svg class="icon flex-1 mx-10 m-2 h-14 w-auto" xmlns="http://www.w3.org/2000/svg" viewBox="-2 -7.5 24 24" width="24">
