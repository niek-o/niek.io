...
<template>
  <div class="frame">
    ...
    <div class="card" v-if=track.youtubeLink>
      <hr>
      <div class="item justify-self-start"><Button :url=track.youtubeLink text="WATCH" :background-color=track.buttonColor :text-color=track.buttonTextColor /></div>
